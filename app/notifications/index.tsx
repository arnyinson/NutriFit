...
import {
  ChevronLeft, Bell, Utensils, Dumbbell, BarChart3,
  Trophy, BellOff, X,
      ...
      >
        {filterConfig.map(filter => {
          ...
          return (
            ...
            >
              <filter.Icon size={13} color={isActive ? '#fff' : colors.textMuted} />
              <Text style={[styles.filterText, { color: colors.textMuted }, isActive && styles.filterTextActive]}>
                {filter.label}
              </Text>
            </TouchableOpacity>
          );
