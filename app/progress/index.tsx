        ...
        >
          ...
          <View style={styles.bodyProgressRow}>
            <View style={styles.bodyStatBox}>
              <Text style={[styles.bodyStatLabel, { color: colors.textMuted }]}>
                Start
              </Text>
        ...
        >
          ...
          <View style={styles.calorieRow}>
            <View style={styles.calorieBox}>
              ...
              <View
                style={[styles.calorieBar, { backgroundColor: colors.border }]}
              >
                <View
                  style={[
        ...
        >
          ...
          <View style={styles.consistencyRow}>
            ...
            >
              ...
              />
              <Text style={[styles.consistencyValue, { color: colors.text }]}>
                {weeklyData.workoutCompletion}%
              </Text>
              <Text
                style={[styles.consistencyLabel, { color: colors.textMuted }]}
              >
                Workout Completion
              </Text>
              <View
        ...
        <View style={[styles.card, styles.recommendCard]}>
          ...
          {weeklyData.recommendations.map((rec, i) => (
            <View key={i} style={styles.recommendRow}>
              ...
              <Text
                style={[styles.recommendText, { color: colors.textSecondary }]}
              >
                {rec}
              </Text>
            </View>
